...
CREATE TABLE `img`  (
  ...
  `add_time` int(11) DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '图片表' ROW_FORMAT = Compact;
...
CREATE TABLE `user`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 91 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户表' ROW_FORMAT = Compact;
...
INSERT INTO `user` VALUES (90, 'https://wx.qlogo.cn/mmopen/vi_32/PiajxSqBRaEK77p9OY0W2kYiapqjSpPV9ESc7Dqw5S82VWLeSDJCt2ny35Pkj8uq0nj4ectJe56oWxMmgy7b4sNQ/0', '郭某', 'ozOjy0FqhGIBNpIdFL2VYfF_dEXY', 2017121611);
